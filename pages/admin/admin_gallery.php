...
<div class="dashboard-route container">
  ...
  <a href="admin_add_gallery.php"><button id="add-news">Add Photos</button></a>
</div>

<section class="container dashboard-content imgGallery">
<div class="row">
              ...
              if(isset($_POST['currentpage'])) {
                ...
                $newCount = 1;
                    ...
                    foreach($gallery as $gall) {
                      ...
                      <a onclick="return confirm(\'Are you sure you want to delete contact?\')" href="../../assets/php/admin_delete_gallery.php?id='.$gall['image_ID'].'"><i class="fa fa-trash" style="color: red; font-size: 18px; margin-left: auto; float: right;"></i></a>
