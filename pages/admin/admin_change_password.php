...
?>
  ...
  <section id="contentSection">
    <div class="login-box adminPass" >
    <h2>Change Password</h2>
    <form action="../../assets/php/ajax.php" method="post" enctype="multipart/form-data">
    <input type="password" id="password-text" name="currentPassword" class="loginInput" placeholder="Current Password" required> <br>
    <input type="password" id="new-password-text" name="newPassword" class="loginInput" placeholder="New Password" required> <br>
    <input type="password" id="conf-password-text" name="confirm-password" class="loginInput" placeholder="Confirm New Password" required>
    <button id="loginBtn" name="adminChangePassword">save</button> <br>
    </form>
    </div>
  </section>
